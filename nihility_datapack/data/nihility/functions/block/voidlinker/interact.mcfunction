...
execute if score temp nihility.data matches 0 if data entity @s SelectedItem as @e[type=minecraft:end_crystal,tag=nihility.voidlinker_crystal,sort=nearest,limit=1] at @s positioned ~ ~.7 ~ run function nihility:block/voidlinker/place/main
