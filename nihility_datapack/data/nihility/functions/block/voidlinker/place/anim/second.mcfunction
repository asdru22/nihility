...
execute at @s unless block ~ ~ ~ #nihility:unbreakable run setblock ~ ~ ~ end_gateway{Age:2222} 
data modify storage nigility:storage root.temp.data set from entity @s Pos
