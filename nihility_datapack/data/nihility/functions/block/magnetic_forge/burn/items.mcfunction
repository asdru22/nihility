...
execute store success score burn nihility.data if data storage nihility:storage root.temp.item.tag.smithed{id:"nihility:kindling_crystal"} run loot spawn ~ ~ ~ loot nihility:item/rekindled_crystal
