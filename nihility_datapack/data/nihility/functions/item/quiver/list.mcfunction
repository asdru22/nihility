...
## add item to list
execute unless score findSame nihility.data matches 1 run data modify storage nihility:storage root.temp.item.tag.nihility.QuiverItems insert 0 from storage nihility:storage root.temp.item.tag.Items[0]